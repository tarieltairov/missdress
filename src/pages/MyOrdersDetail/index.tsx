    ...
    <div className={styles.orders}>
      <Row>
        ...
        <Col className={styles.orders_header}>
          ...
          <Typography.Text className={styles.orders_header__delivered}>
            ...
            <Col>
              <Row gutter={[0, 24]}>
                ...
                <Col span={24}>
                  <Row>
                    <Col span={12}>
                      <Typography.Text>Адрес доставки:</Typography.Text>
                    </Col>
                    <Col>
                      <Typography.Text>
                        {orders &&
                ...
                <Col span={24}>
                  <Row>
                    <Col span={12}>
                      <Typography.Text>Итого к оплате:</Typography.Text>
                    </Col>
                    <Col>
                      <Typography.Text>20000 c.</Typography.Text>
                    </Col>
                  </Row>
                </Col>
              </Row>
