    ...
    >
                ...
                >
                  ...
                  {!mobile && (
                    <Col className={styles.ordering_info}>
                      <Typography
                        className={styles.ordering_info_item}
                        style={{
                          marginRight: "15px",
                        }}
                      >
                      ...
                      <Typography className={styles.ordering_info_subitem}>
                        {article}
                      </Typography>
                    </Col>
                  )}
              ...
              <Col>
                <Row gutter={[20, 20]} align="bottom">
                  <Col>
                    ...
                    >
                      <img
                        className={styles.button_card_icons}
                        src={minus}
                        alt="minus"
                      />
                    </OrderingButton>
      ...
      <Col span={4}>
        ...
        >
          ...
          <Col>
            <Row className={styles.price} style={{ flexDirection: "column" }}>
              <Col className={styles.currentPrice}>{price}</Col>
